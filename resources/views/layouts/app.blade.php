...
<body>
   <!-------------------------------------------------Navbar Starts---------------------------------------------------->
    ...
    ?>
     @if($notifications)
        <?php          
          ...
          $respons= json_decode( $notifications->data,true);
         
    ?>
        @if($respons["is_accept"]==true)
     <div class="alert alert-success alert-dismissible fade show" role="alert">
          <strong>votre projet <b>{{ $respons["titre"]}}</b> est lancé sur notre site</strong>.
          <button type="button" id="close_btn"class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
          </div>
          @elseif($respons["is_accept"]==false)
          <div class="alert alert-danger alert-dismissible fade show" role="alert">
          <strong>votre projet <b>{{ $respons["titre"]}}</b> est refuser</strong>.
          <button type="button" id="close_btn" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
          </div>
          <p>{{$respons["raison"]}}</p>
          @endif
    ...
    ->where('id', $respons['idNotification']) // Optional: Use a condition to update specific records
    ->update(['read_at' => $now]); ?>
     @endif
      @else
      <header id="header_navbar" class="position-relative">
    ...
    <!-- -----------------------------------------------Navbar Ends-------------------------------------------------- -->
      ...
      <div class="container">
        <div class="div_1">
          <div class="left_col">
            <p class="titre">Aide et ressources</p>
            <p class="sous_titre"><a href="#">Lancer mon projet</a></p>
            <p class="sous_titre"><a href="#">Découvrir les projets</a></p>
          </div>
          <div class="right_col">
            <p class="titre">Â propos</p>
            <p class="sous_titre"><a href="#">Découvrir Toogether</a></p>
            <p class="sous_titre"><a href="#">Crowdfunding</a></p>
          </div>
        </div>
      </div>
      <hr />
      <div class="div_2">
        ...
        <div class="row_2">
          <div class="logo">
            <a href="#"><img src="{{asset('assets-app/images/logo.png')}}" alt="" /></a>
          </div>
          <div class="text">
            <i class="fa-regular fa-copyright p-1"></i> 2023
          </div>
        </div>
      </div>
    </section>
